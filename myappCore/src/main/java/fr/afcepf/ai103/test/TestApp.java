...
//		user.setNom("zzzzzzz");
//		
//		AlimentGenerique aliment = new AlimentGenerique();
//		aliment.setLibelleAlimentGenerique("nouvel aliment");
//		
//		StockPerso stock = new StockPerso(1, null, null, null, user, aliment);
//		
////		StockPerso stock = new StockPerso();
////		stock.getAlimentGenerique().setIdAlimentGenerique(1);
////		stock.setAlimentGenerique(new AlimentGenerique());
////		stock.setQuantiteStockPerso(1);
//	
//		
//		DaoStockPerso daoStockPerso = new DaoStockPerso();
//		daoStockPerso.setEntityManager(em);
//
//		ServiceStockPerso serviceStockPerso = new ServiceStockPerso();
//		serviceStockPerso.setDaoStockPerso(daoStockPerso);
//
//		
////		System.err.println("DAO Stock Utilisateur 2 = " + //
////				daoStockPerso.getStockByIdUtilisateur(2).toString());
////
////		System.err.println("DAO idStock 3 = " + //
////				daoStockPerso.getAlimentById(3).toString());
//		
//		System.err.println("DAO ajout aliment = " + //
//				daoStockPerso.setAlimentAuStock(stock));
//		
////		System.err.println("SERVICE Stock Utilisateur 2 = " + //
////				serviceStockPerso.afficherStockByIdUtilisateur(2).toString());
////
////		System.err.println("SERVICE idStock 3 = " + //
////				serviceStockPerso.recupererAlimentById(3));
////		
//////		System.err.println("SERVICE ajout aliment = " + //
////				serviceStockPerso.ajouterAlimentAuStock(stock));
//
//	
//
//		daoStockPerso.getEntityManager().getTransaction().commit();
//		daoStockPerso.getEntityManager().close();
//		
//		emf.close();
		...
		//
		// System.out.println("Adresse by ville - idVille = 1 - : " +
		// serviceVille.rechercherAdresseByNomVille(1));
