...
public class DashboardView implements Serializable {
	...
	public void init() {
		...
		valAnnoncePublie = serviceAnnonce.getNbrAnnonceEnCours(2);
		
		System.out.println(valAnnoncePublie + " Valeur");
	}
	...
	private Long valAnnoncePublie;

	public Long getValAnnoncePublie() {
		return valAnnoncePublie;
	}

	public void setValAnnoncePublie(Long valAnnoncePublie) {
		this.valAnnoncePublie = valAnnoncePublie;
	}
}
